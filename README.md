...
- 🎯 Entry points to execute your program using `python -m <wangzhi>` or `$ wangzhi` with basic CLI argument parsing.
...
---
# wangzhi Flask Application

Awesome wangzhi created by 15620363888
...
```bash
git clone https://github.com/15620363888/wangzhi wangzhi
cd wangzhi
make install
```
...
```bash
wangzhi create-db   # run once
wangzhi populate-db  # run once (optional)
wangzhi add-user -u admin -p 1234  # ads a user
wangzhi run
```
